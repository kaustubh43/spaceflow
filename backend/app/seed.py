...
def seed_villas(db, c: dict[str, CatalogItem]) -> None:
    ...
    if not db.scalar(select(Project).where(Project.name == "Luxury 4BHK Villa")):
        ...
        els += [
            ...
            _place(u, c["Marble Flooring (Area)"], 940, 300, w=420, d=440, name="Lounge marble"),
            ...
            _place(u, c["Sofa (3-seat)"], 850, 460),
            _place(u, c["Television"], 850, 90),
    ...
    if not db.scalar(select(Project).where(Project.name == "Hillside Duplex Villa")):
        ...
        els += [
            ...
            _place(u, c["Wooden Flooring (Area)"], 880, 250, w=320, d=340, name="Bed2 wood"),
            ...
            _place(u, c["Single Bed"], 780, 200, client_editable=True),
